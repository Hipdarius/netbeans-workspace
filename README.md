...
This repository collects every project written for the **SciPr** (Scientific
...
| Folder | Description |
| --- | --- |
| `G1_ShapeDrawer` | Shape-drawing exercise: introduction to OOP with `Shape`, `Line`, `Rectangle`. |
| `G2_Emojis` | Emoticon faces drawn with `Graphics2D`, plus a small bouncing-ball demo. |
| `G3_Javapede` | Javapede game: player, bullets, mushrooms. |
| `E9_FallingBalls` | Falling-balls animation exercise. |
...
Everything in this repository is free to use. You may copy, modify, and
redistribute any of the code without restriction.
